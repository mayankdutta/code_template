...
void Tree::Insert (int key) { 
    ...
    //insert_at -> right = (insert_at -> data > key) ? temp : insert_at -> left = temp;
    if (insert_at -> data < key) insert_at -> right = temp; 
    else  insert_at -> left = temp; 
...
bool Tree::isBST (node *leaf, int low, int high) { 
    ...
    if (low < leaf -> data && leaf -> data < high) { 
        return 
            isBST (leaf -> left, low, high - leaf -> data) && 
